...
/* @see http://developer.ebay.com/DevZone/merchant-data/CallRef/OrderReport.html */

$orderReportFilter = new BulkDataExchange\Types\OrderReportFilter();
$orderReportFilter->orderStatus = BulkDataExchange\Enums\OrderStatusTypes::C_ALL;
$orderReportFilter->version = 959;

$startDownloadJobRequest = new BulkDataExchange\Types\StartDownloadJobRequest();
$startDownloadJobRequest->downloadJobType = 'OrderReport';
$startDownloadJobRequest->UUID = uniqid('', true);
$startDownloadJobRequest->downloadRequestFilter = new BulkDataExchange\Types\DownloadRequestFilter();
$startDownloadJobRequest->downloadRequestFilter->orderReportFilter = $orderReportFilter;
